...
const questions = [
    {
        ...
        validate: nameInput => {
            if (nameInput) {
                ...
                console.log('Provide a project title.');
                return false;
            }
        }
    },
    ...
    },
    {
        type: 'input',
        name: 'usage',
        message: 'Provide information for using your application.',
        validate: usageInput => {
            if (usageInput) {
                return true;
            } else {
    ...
    },
    {
        ...
        validate: licenseInput => {
            if (licenseInput) {
                ...
                console.log('Provide license information.');
                return false;
            }
        }
    }, 
    {
        type: 'checkbox',
        name: 'built with',
        message: 'Select the technologies that your application was built with.',
    ...
    },
    {
        type: 'input',
        name: 'questions',
        message: 'Provide an email address for others to reach you with questions.',
        when: ({ contents }) => {
...
const screenshotQues = [
    {
        type: 'input',
        name: 'screenshotLink',
        message: 'Provide a link for your screenshot.',
    ...
    },
    {
        type: 'input',
        name: 'screenshotAlt',
        message: 'Provide alt text for your screenshot.',
    ...
    },
    {
        type: 'input',
        name: 'screenshotDesc',
        message: 'Provide a description of your screenshot.'
    },
    {
        type: 'confirm',
...
const creditQues = [
    ...
    },
    {
        type: 'input',
        name: 'creditLink',
        message: 'Provide a link for the credit.',
        validate: creditLink => {
            if (creditLink) {
                return true;
            } else {
